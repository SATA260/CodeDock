...
import { ModelEffortMenu, PermissionMenu } from "./composer-menus.tsx";
import { formatTokens, remainingContext } from "./lib/format.ts";

// ClaudePromptBar 是底栏输入：回车锁回输入框，设置在下方菜单点选即生效。
export function ClaudePromptBar({
  running,
  sending,
  sessionId,
  workspace,
  ...
  onSend: (text: string, mode: "start" | "queue") => Promise<void>;
      ...
      >
        <div className="flex items-start">
          ...
          <PromptInputTextarea
            ...
            placeholder="给 Claude 发消息，或输入 / 选斜杠命令…"
        ...
        <PromptInputFooter className="flex-wrap">
          <PromptInputTools>
            ...
            <PermissionMenu modes={modes} settings={settings} onApply={onApply} />
...
// CompactButton 显示官方剩余上下文，没有用量时只写「压缩」。
...
// AttachButton 打开本机文件选择，把路径交给挂载接口。
