...
func testRouter(api *handler.API) http.Handler {
	...
	r.Get("/works", api.ListWorks)
	r.Get("/works/{work_id}", api.GetWork)
	r.Patch("/works/{work_id}", api.UpdateWork)
	r.Delete("/works/{work_id}", api.DeleteWork)
	r.Post("/works/{work_id}/checkouts", api.AttachWorkCheckout)
	r.Get("/works/{work_id}/checkouts", api.ListWorkCheckouts)
	r.Delete("/works/{work_id}/checkouts", api.DetachWorkCheckout)
	r.Get("/works/{work_id}/info", api.GetWorkInfo)
	r.Put("/works/{work_id}/info", api.PutWorkInfo)
	r.Post("/works/{work_id}/sessions", api.StartWorkSession)
	r.Post("/works/{work_id}/placements", api.AttachWorkPlacement)
	r.Get("/works/{work_id}/inbox", api.ListWorkInbox)
	r.Get("/board", api.GetBoard)
	r.Get("/board/cards/{work_id}", api.GetBoardCard)
	r.Get("/placements", api.ListPlacements)
	r.Get("/placements/{engine}/{session_id}", api.GetPlacement)
	...
	r.Delete("/session-links/{engine}/{session_id}/issue", api.DeleteSessionIssue)
	r.Post("/session-links/{engine}/{session_id}/pulls", api.PutSessionPull)
	r.Delete("/session-links/{engine}/{session_id}/pulls/{number}", api.DeleteSessionPull)
	return r
}
